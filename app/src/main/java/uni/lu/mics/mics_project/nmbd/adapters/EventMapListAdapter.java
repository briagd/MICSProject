...
public class EventMapListAdapter extends RecyclerView.Adapter<EventMapListAdapter.EventListViewHolder>{
    ...
    private EventMapCallBack mlistener;
    private final Context context;


    public EventMapListAdapter(Context context, ExtendedListEvent extList, EventMapCallBack listener) {
    ...
    public EventListViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View mItemView = mInflater.inflate(R.layout.event_map_cardview_item,
                parent, false);
    ...
    public class EventListViewHolder extends RecyclerView.ViewHolder{
        ...
        private final EventMapListAdapter mAdapter;
        private EventMapCallBack myClickListener;

        private EventListViewHolder(View itemView, EventMapListAdapter adapter){
            super(itemView);
            ...
            showOnMapButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    myClickListener.onShowOnMapClick(getAdapterPosition());
                }
            });
            viewEventButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    myClickListener.onViewEventClick(getAdapterPosition());
                }
            });
